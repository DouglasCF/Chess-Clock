...
class HomeViewModel: ObservableObject {
    @Published private(set) var game: Game = Game(totalTime: 1*60, increment: 2, isPlaying: false, isWhiteMove: true, whiteTimeRemaining:1*60*1000, blackTimeRemaining: 1*60*1000)
